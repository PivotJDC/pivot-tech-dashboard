...
/** All 50 US states + DC, as { value: USPS code, label: full name }. */
...
export interface UsStatesSelectProps {
  value: string;
...
/** A styled native <select> of all US states + DC. Matches the Input look. */
export function UsStatesSelect({
  value,
  onChange,
  disabled,
  className,
